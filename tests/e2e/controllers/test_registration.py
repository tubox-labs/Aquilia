...
class TestRegistrationJSON:
    ...
    async def test_register_success(self, client):
        ...
        payload = {
            "username": "json_tester",
            "email": _unique_email("json"),
            "password": "Str0ngP@ss!",
            "name": {"first_name": "JSON Tester", "last_name": "User"},
        }
        ...
        assert body["name"]["first_name"] == payload["name"]["first_name"]
        assert "id" in body
    ...
    async def test_register_returns_id(self, client):
        ...
        payload = {
            ...
            "password": "Str0ngP@ss!",
            "name": {"first_name": "ID Check", "last_name": "User"},
        }
        resp = await client.post("/auth/register", json=payload)
...
class TestRegistrationForm:
    ...
    async def test_register_form_redirect(self, client):
        ...
        payload = {
            "username": "form_tester",
            "email": _unique_email("form"),
            "password": "Str0ngP@ss!",
            "name.first_name": "Form Tester",
            "name.last_name": "User",
        }
...
class TestDuplicateRegistration:
    ...
    async def test_duplicate_email_rejected(self, client):
        ...
        payload = {"username": "dup_user", "email": email, "password": "Str0ngP@ss!", "name": {"first_name": "First", "last_name": "User"}}
...
class TestRegistrationValidation:
    ...
    async def test_missing_email(self, client):
        ...
        resp = await client.post("/auth/register", json={
            "username": "no_email",
            "password": "Str0ngP@ss!",
            "name": {"first_name": "No Email", "last_name": "User"},
        })
    ...
    async def test_missing_password(self, client):
        ...
        resp = await client.post("/auth/register", json={
            ...
            "name": {"first_name": "No Password", "last_name": "User"},
        })
        assert 400 <= resp.status_code < 500
