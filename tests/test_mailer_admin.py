...
class TestAdminPermissionsMailer:
    ...
    def test_admin_role_has_mailer_view(self):
        ...
        has_perm = (
            AdminPermission.MAILER_VIEW in admin_perms or
            AdminPermission.FULL_ACCESS in admin_perms
        )
        assert has_perm
...
class TestRenderMailerPage:
    ...
    def _sample_data(self, available=True, enabled=True):
        return {
            ...
            "providers": [
                {
                    "name": "smtp-primary", "type": "smtp",
                    "type_display": "SMTP", "enabled": True, "active": True,
                    "priority": 10, "rate_limit_per_min": 1000,
                    "host": "smtp.example.com", "port": 587,
                    "use_tls": True, "use_ssl": False, "timeout": 30.0,
                    "status": "active",
                }
            ],
            "provider_count": 1,
            ...
            "security": {
                "dkim_enabled": True, "dkim_domain": "example.com",
                "dkim_selector": "aquilia", "require_tls": True,
                "pii_redaction_enabled": False, "allowed_from_domains": ["example.com"],
            },
            "templates": {"template_dirs": ["mail_templates"], "auto_escape": True, "cache_compiled": True, "strict_mode": False},
...
class TestSecurityTabData:
    ...
    def test_template_shows_dkim_enabled(self):
        ...
        data = {
            ...
            "providers": [], "provider_count": 0, "active_provider_count": 0,
            "default_from": "a@b.com", "default_reply_to": None,
            "subject_prefix": "", "preview_mode": False,
            "console_backend": False, "metrics_enabled": False,
            "tracing_enabled": False, "is_healthy": True,
            "retry": {}, "rate_limit": {}, "queue": {},
            "templates": {},
            "security": {"dkim_enabled": True, "dkim_domain": "x.com",
                         "dkim_selector": "s1", "require_tls": True,
                         "pii_redaction_enabled": False,
                         "allowed_from_domains": ["x.com"]},
            "stats": {"total_sent": 0, "total_failed": 0,
                      "total_queued": 0, "total_bounced": 0},
        }
        html = render_mailer_page(data)
        assert "DKIM" in html
...
class TestMailerEdgeCases:
    ...
    def test_render_empty_providers_list(self):
        ...
        data = {
            ...
            "subject_prefix": "", "preview_mode": False,
            "console_backend": False, "metrics_enabled": False,
            "tracing_enabled": False, "is_healthy": False,
            "retry": {}, "rate_limit": {}, "security": {},
            "templates": {}, "queue": {},
            "stats": {"total_sent": 0, "total_failed": 0,
                      "total_queued": 0, "total_bounced": 0},
        }
    ...
    def test_render_with_multiple_providers(self):
        ...
        data = {
            "available": True, "enabled": True, "config": {},
            "providers": [
                {"name": "primary", "type": "smtp", "type_display": "SMTP",
                 "enabled": True, "active": True, "priority": 10,
                 "rate_limit_per_min": 1000, "host": "smtp.a.com", "port": 587,
                 "use_tls": True, "use_ssl": False, "timeout": 30, "status": "active"},
                {"name": "fallback", "type": "ses", "type_display": "AWS SES",
                 "enabled": True, "active": False, "priority": 50,
                 "rate_limit_per_min": 500, "host": None, "port": None,
                 "use_tls": False, "use_ssl": False, "timeout": 60, "status": "inactive"},
            ],
            "provider_count": 2, "active_provider_count": 1,
            "default_from": "a@b.com", "default_reply_to": None,
            "subject_prefix": "", "preview_mode": False,
            "console_backend": False, "metrics_enabled": True,
            "tracing_enabled": True, "is_healthy": True,
            ...
            "security": {"dkim_enabled": False, "dkim_domain": None, "dkim_selector": "aquilia",
                         "require_tls": True, "pii_redaction_enabled": False, "allowed_from_domains": []},
    ...
    def test_render_preview_mode_shown(self):
        ...
        data = {
            ...
            "providers": [], "provider_count": 0, "active_provider_count": 0,
            "default_from": "a@b.com", "default_reply_to": None,
            "subject_prefix": "", "preview_mode": True,
            "console_backend": False, "metrics_enabled": False,
            "tracing_enabled": False, "is_healthy": True,
            "retry": {}, "rate_limit": {}, "security": {},
            "templates": {}, "queue": {},
    ...
    def test_render_mailer_page_with_minimal_data(self):
        ...
        from aquilia.admin.templates import render_mailer_page
        data = {
            "available": False, "enabled": False, "config": {},
            "providers": [], "provider_count": 0, "active_provider_count": 0,
            "default_from": "", "default_reply_to": None,
            "subject_prefix": "", "preview_mode": False,
            "console_backend": False, "metrics_enabled": False,
            "tracing_enabled": False, "is_healthy": False,
            "retry": {}, "rate_limit": {}, "security": {},
...
class TestFullRenderingPipelineSmoke:
    ...
    def _make_wired_site(self):
        ...
        config.security = MagicMock(dkim_enabled=False, dkim_domain=None, dkim_selector="aquilia",
                                     require_tls=True, pii_redaction_enabled=False, allowed_from_domains=[])
