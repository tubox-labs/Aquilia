...
import {
  ...
  Rocket, Box, Terminal, Code2, GitBranch, ArrowRight
} from 'lucide-react'
      ...
      <div className="relative mb-20 overflow-hidden">
        ...
        <div className="flex items-start gap-5 mb-6">
          <div className="flex-shrink-0">
            <img src="/logo.png" alt="Aquilia" className="w-16 h-16 rounded-2xl" />
          </div>
          <div>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-10">
          <Link
            to="/docs/quickstart"
            className="group inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-aquilia-600 hover:bg-aquilia-500 text-white font-semibold shadow-md transition-all duration-200 hover:scale-105 active:scale-95"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-12">
          <div className="flex-1">
            <CodeBlock code="pip install aquilia" language="bash" compact />
          </div>
          <div className="flex-1">
            <CodeBlock code="uv pip install aquilia" language="bash" compact />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h3 className={`text-xs font-bold uppercase tracking-widest mb-3 ${isDark ? 'text-zinc-500' : 'text-gray-400'}`}>What is Aquilia?</h3>
          ...
          <div>
            <h3 className={`text-xs font-bold uppercase tracking-widest mb-3 ${isDark ? 'text-zinc-500' : 'text-gray-400'}`}>Who is it for?</h3>
            <p className={`text-sm leading-relaxed ${isDark ? 'text-zinc-300' : 'text-gray-600'}`}>
              Teams building{' '}
