    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-12">
        ...
        <p className={`text-lg leading-relaxed ${textMuted}`}>
          Composable onion-model middleware layers for wrapping outbound HTTP request-response cycles.
        </p>
      </div>
      ...
      <section className="mb-16">
        ...
        <div className="border-l-2 border-aquilia-500/20 pl-4 py-1 text-sm text-zinc-500 space-y-2">
          <p>
            <code className="text-aquilia-500 font-mono">middleware.py</code> handles request processing and response interception in an onion-like flow.
          </p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <CodeBlock language="python" filename="middleware.py interface" highlightLines={[1, 5]}>{`class HTTPClientMiddleware(ABC):
    @abstractmethod
    async def __call__(
        self,
