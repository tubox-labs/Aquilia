...
export function I18nEdgeCases() {
  ...
  const validated: string[] = [
    ...
    'Unicode content is preserved across memory and JSON-backed catalogs.',
  ...
  const limitations: string[] = [
    ...
    'Service catalog build path defaults to FileCatalog JSON extensions unless customized.',
