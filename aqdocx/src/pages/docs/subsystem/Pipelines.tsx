    ...
    <div className="max-w-4xl mx-auto py-6 font-sans">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-2 text-sm text-aquilia-500 font-mono mb-4">
          ...
          <span>SUBSYSTEM / FLOW PIPELINES</span>
        </div>
...
PRIORITY_CLEANUP   = 80  # Post-request teardowns, resource recycling.`}</CodeBlock>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-8">
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`def pipeline(name: str = "pipeline", *, timeout: float | None = None) -> FlowPipeline`}</CodeBlock>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`.guard(node, *, name: str | None = None, priority: int = 20, effects: list[str] | None = None, condition: Callable | None = None)`}</CodeBlock>
            <p className={`font-light text-sm mt-2 mb-6 ${textMuted}`}>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`.transform(node, *, name: str | None = None, priority: int = 40, effects: list[str] | None = None)`}</CodeBlock>
            <p className={`font-light text-sm mt-2 mb-6 ${textMuted}`}>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`.handler(node, *, name: str | None = None, priority: int = 50, effects: list[str] | None = None)`}</CodeBlock>
            <p className={`font-light text-sm mt-2 mb-6 ${textMuted}`}>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`.hook(node, *, name: str | None = None, priority: int = 70, effects: list[str] | None = None)`}</CodeBlock>
            <p className={`font-light text-sm mt-2 mb-6 ${textMuted}`}>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`.compose(*other: FlowPipeline) -> FlowPipeline`}</CodeBlock>
            <p className={`font-light text-sm mt-2 mb-6 ${textMuted}`}>
          ...
          <div>
            <CodeBlock language="python" compact showLineNumbers={false}>{`from_pipeline_list(nodes: Sequence[Any], *, name: str) -> FlowPipeline`}</CodeBlock>
