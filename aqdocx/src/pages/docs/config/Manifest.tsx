          ...
          <table className="w-full text-sm">
            ...
            <tbody className={`divide-y ${divider}`}>
              {[
                ...
                ['vector_models', 'list[str | ComponentRef]', 'aquilia.vectordb model classes. Kept separate from models because the two bind to different backends — a VectorModel has no table and never appears in a SQL migration. New in 1.4.0b3.'],
                ...
                ['auto_discover', 'bool (default True)', 'Scan controllers/, services/, models/, vector_models/, guards/, tasks/ subdirs by convention.'],
                ['discover_patterns', 'list[str]', 'Subdirectory names scanned when auto_discover=True. Defaults: ["controllers", "services", "middleware", "guards", "models", "vector_models", "tasks"].'],
          ...
          <table className="w-full text-sm">
            ...
            <tbody className={`divide-y ${divider}`}>
              {[
                ...
                ['VECTOR_MODEL',      '"vector_model"',      'Vector collection model classes (aquilia.vectordb) — no table, never in a SQL migration'],
