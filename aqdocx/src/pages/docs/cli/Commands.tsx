      ...
      <section className="mb-16">
        ...
        <div className="space-y-6">
          {[
            ...
            { cmd: 'aq compile', desc: 'Compile manifests to artifacts', usage: 'aq compile --output artifacts', details: 'Writes explicit JSON artifacts for inspection and tooling. Runtime loads the workspace directly.' },
