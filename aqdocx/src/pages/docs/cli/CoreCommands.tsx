...
aq validate --strict --json`}</CodeBlock>
      ...
      <section id="compile" className={sectionClass}>
        ...
        <p className={pClass}>
          Compiles modular controllers, routers, contracts, and translations into a compiled directory of static `.json` files. This is recommended before deploying to production.
        </p>
