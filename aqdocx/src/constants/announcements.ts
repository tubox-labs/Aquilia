...
export const ANNOUNCEMENTS: Record<string, Announcement> = {
  '1.4.2': {
    version: '1.4.2',
    badgeText: 'V1.4.2 Depths Unknown Release',
    title: 'Forensic verification release: AniWave audit repairs, HTTP client overhaul, DB transaction integrity, worker resilience, and manifest safety:',
    highlightText: 'Depths Unknown',
    linkText: 'Learn More',
    linkTo: '/releases/1.4.2',
  },
  '1.4.1': {
    version: '1.4.1',
    badgeText: 'V1.4.1 Safe Harbor Release',
    title: 'Authentication & authorization architecture rebuild, NestJS migration audit fixes, durable DB/Redis stores, and async guards:',
    highlightText: 'Safe Harbor',
    linkText: 'Learn More',
    linkTo: '/releases/1.4.1',
  },
  '1.4.0': {
    version: '1.4.0',
    badgeText: 'V1.4.0 Stable Release',
    title: 'Native C++ acceleration, VectorDB subsystem, native ASGI devplatform, WebSocket middleware pipeline, and unified CLI health checks:',
    highlightText: 'Grand Armada',
    linkText: 'Learn More',
    linkTo: '/releases/1.4.0',
  },
  '1.4.0b5': {
    version: '1.4.0b5',
