...
registerDocEntities([
  ...
  },
  {
    ...
    type: 'decorator',
    title: '@validate_body(blueprint_class)',
    description: 'Decorator that parses and validates request bodies using an Aquilia Blueprint. Passes validated_data downstream as "body".',
    signature: 'def validate_body(blueprint_class: type, *, projection: str = "__all__") -> Callable',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
  ...
  },
  {
    ...
    signature: '@GET(path: str | None = None, *, pipeline: list[Any] = None, request_blueprint: type = None, response_blueprint: type = None, filterset_class: type = None, pagination_class: type = None, version: str | list[str] = None)',
    language: 'python',
    status: 'stable',
  ...
  },
  {
    ...
    signature: '@POST(path: str | None = None, *, pipeline: list[Any] = None, request_blueprint: type = None, response_blueprint: type = None, status_code: int = 201)',
    language: 'python',
    status: 'stable',
