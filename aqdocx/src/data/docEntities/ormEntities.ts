...
user.to_dict(fields=["id", "name"
  ...
  {
    id: 'orm.queryset.values',
    type: 'method',
    title: 'values()',
    description: 'Returns dictionaries instead of model instances.',
    signature: 'def values(self, *fields: str) -> QuerySet',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
  ...
  {
    id: 'orm.queryset.values_list',
    type: 'method',
    title: 'values_list()',
    description: 'Returns tuples instead of model instances. Set flat=True for single field.',
    signature: 'def values_list(self, *fields: str, flat: bool = False) -> QuerySet',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/queryset',
  ...
  {
    id: 'orm.queryset.exists',
    type: 'method',
    title: 'exists()',
    description: 'Returns True if the QuerySet contains any results, False otherwise.',
    signature: 'async def exists(self) -> bool',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/queryset',
  ...
  {
    id: 'orm.queryset.delete',
    type: 'method',
    title: 'delete()',
    description: 'Bulk deletes all rows matching the QuerySet.',
    signature: 'async def delete(self) -> int',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
  ...
  {
    id: 'orm.queryset.update',
    type: 'method',
    title: 'update()',
    description: 'Bulk updates all rows matching the QuerySet.',
    signature: 'async def update(self, **kwargs) -> int',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/bulk-operations',
  ...
  {
    id: 'orm.queryset.none',
    type: 'method',
    title: 'none()',
    description: 'Returns an empty QuerySet that never hits the database.',
    signature: 'def none(self) -> QuerySet',
    language: 'python',
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/queryset',
...
one   = await qs.get(id=5) # raises if not found`,
    ...
    related: [
      ...
      { label: 'Manager', id: 'orm.manager' },
      { label: 'CTEs', href: '/docs/models/cte' },
      { label: 'Bulk Ops', href: '/docs/models/bulk-operations' },
    ],
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/queryset',
...
posts = await Post.objects.prefetch_related(
...

  {
    ...
    language: 'python',
    example: {
      code: `from aquilia.models import Count, F, Upper
...
users = await User.objects.annotate(
    ...
    related: [{ label: 'Aggregation', href: '/docs/models/aggregation' }, { label: 'Window Functions', href: '/docs/models/window-functions' }],
    status: 'stable',
    version: 'v1.0+',
...
users = await User.objects.annotate(posts=Count("post")).all()`,
    ...
    related: [{ label: 'Sum()', id: 'orm.sum' }, { label: 'Aggregation', href: '/docs/models/aggregation' }, { label: 'Window Functions', href: '/docs/models/window-functions' }],
    status: 'stable',
    version: 'v1.0+',
    docsHref: '/docs/models/aggregation',
