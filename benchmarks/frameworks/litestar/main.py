...
from litestar import Litestar, get, post, websocket, Request, WebSocket
...
# Setup app handlers
route_handlers = [
    health, plaintext, json_endpoint, json_large, db_single, db_queries, db_updates,
    fortunes, cached_test, validation_pydantic, route_static, route_params,
    di_chain, body_multipart, response_stream, ws_echo
]
