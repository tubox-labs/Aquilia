...
`contracts` has 9 Python files, 41 public classes, 10 public module-level functions, and 15 constants or module flags detected by AST.
...
| --- | --- | --- |
| `ProjectionRegistry` | `aquilia/contracts/projections.py` | Manages named projections for a Contract class. |
