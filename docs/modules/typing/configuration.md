# Typing Contracts Configuration
...
| --- | --- | --- | --- |
| `ManifestDescriptor` | `aquilia/typing/manifest.py` | name: ManifestName, module: ModuleName, class_path: ClassPath | Configuration or typed data class. |
