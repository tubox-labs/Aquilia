...
| [contracts](modules/contracts/README.md) | Model-to-world contracts for request validation, response rendering, schema generation, facets, projections, and lenses. | 9 | 41 | 10 | [API](modules/contracts/api-reference.md) | [CLI](modules/contracts/cli-reference.md) |
...
| [mail](modules/mail/README.md) | Async mail subsystem with message classes, config contracts, providers, DI registration, templates, faults, and convenience send APIs. | 14 | 41 | 9 | [API](modules/mail/api-reference.md) | [CLI](modules/mail/cli-reference.md) |
