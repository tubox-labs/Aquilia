...
from .bytecode_cache import BytecodeCache, CrousBytecodeCache
...
class TemplateManager:
    ...
    async def _lint_template(
        ...
        try:
            ...
            try:
                ...
                issues.append(TemplateLintIssue(
    ...
    def _extract_module(self, template_name: str) -> Optional[str]:
