...
class SessionTemplateProxy:
    ...
    def authenticated(self) -> bool:
        ...
        return self.has("user_id") or self.has("identity_id") or self.has("authenticated")
...
class FlashMessages:
    ...
    @staticmethod
    def add_flash(session: "Session", message: str, level: str = "info") -> None:
        """
...
def enhance_engine_with_sessions(engine: "TemplateEngine", session_engine: Optional["SessionEngine"] = None) -> None:
    """
...
def inject_session_context(context: dict[str, Any], request_ctx: Optional["RequestCtx"] = None) -> None:
    """
    ...
    flash = FlashMessages(request_ctx.session if request_ctx and hasattr(request_ctx, "session") else None)
...
class TemplateFlashMixin:
    ...
    def flash(self, ctx: "RequestCtx", message: str, level: str = "info") -> None:
        """
        Add flash message to session.
