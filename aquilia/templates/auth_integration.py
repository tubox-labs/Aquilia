...
def create_auth_helpers(identity: Optional["Identity"] = None, authz_engine: Optional["AuthzEngine"] = None):
    """
...
def enhance_engine_with_auth(
    engine: "TemplateEngine", auth_manager: Optional["AuthManager"] = None, authz_engine: Optional["AuthzEngine"] = None
) -> None:
    """
...
def inject_auth_context(
    context: dict[str, Any], request_ctx: Optional["RequestCtx"] = None, authz_engine: Optional["AuthzEngine"] = None
) -> None:
    """
...
class TemplateAuthMixin:
    ...
    def render_with_auth(self, ctx: "RequestCtx", template: str, user_context: dict[str, Any] | None = None, **kwargs):
        """
        ...
        return Response.render(template, final_ctx, engine=self._template_engine, **kwargs)
