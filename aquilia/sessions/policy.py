...
class SessionPolicyBuilder:
    ...
    def absolute_timeout(self, hours: int = None, minutes: int = None, days: int = None) -> "SessionPolicyBuilder":
        ...
        if days: self._absolute_timeout = timedelta(days=days)
        elif hours: self._absolute_timeout = timedelta(hours=hours)
        elif minutes: self._absolute_timeout = timedelta(minutes=minutes)
        return self
